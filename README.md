...
### whoami :man_technologist:
```
applied mathematician and full stack software engineer
```

```
                                                        ┌── modeling, analytics, data strategy
                                                        |
i have worked in many sectors/ delivering solutions in  ├── software engineering
                          ├── IT                        |
                          ├── financial                 └── architecture, product design
                          ├── marketing                      
                          └── telecommunications
```
